...
describe("operation policy coverage", () => {
  const expectedEvents = [
    ...
    "CATEGORY_UPDATE", "CATEGORY_DELETE", "STOCK_RECEIVE", "BATCH_EXPIRY_SET", "BATCH_WRITE_OFF", "BILL_AMEND", "BILL_REVERSE",
    "CUSTOMER_CREATE", "CUSTOMER_UPDATE", "CUSTOMER_CREDIT_LIMIT_UPDATE", "CUSTOMER_CREDIT_SETTLE",
    "ROLE_CREATE", "ROLE_UPDATE", "ROLE_DELETE", "ACCOUNT_CREATE", "ACCOUNT_USERNAME_UPDATE",
    "ACCOUNT_PASSWORD_RESET", "ACCOUNT_DELETE", "ACCOUNT_ROLE_ASSIGN", "SITE_ADMIN_UPDATE",
  ].sort();
