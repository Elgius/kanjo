...
export default async function RestaurantMenuPage({ params, searchParams }: PageProps<"/registers/[registerId]/menu">) {
  ...
  return <PageContainer>
    ...
    {canEdit ? <details className="rounded-xl border border-border bg-card p-4"><summary className="cursor-pointer text-sm font-semibold">Add menu item</summary><div className="mt-4"><MenuItemForm registerId={register.id} products={productOptions} categories={categories} /></div></details> : null}
