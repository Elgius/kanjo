            ...
            <>
              ...
              {shift ? (
                <>
                  ...
                  <form action={recordSaleAction.bind(null, shift.id, selected.id)} className="grid gap-3 rounded-[9px] bg-accent p-4 sm:grid-cols-[1fr_100px_150px_auto] sm:items-end">
