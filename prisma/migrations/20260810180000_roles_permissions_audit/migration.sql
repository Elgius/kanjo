...
VALUES (
  'Full Access',
  'full access',
  'Bootstrap role that preserves access for accounts created before role-based permissions.',
  CURRENT_TIMESTAMP
);
...
UPDATE "user"
SET "roleId" = (
  SELECT "id" FROM "roles" WHERE "normalizedName" = 'full access'
)
