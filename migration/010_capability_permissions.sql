...
ALTER TABLE "roles" ADD COLUMN "registerScopeMode" "RegisterScopeMode" NOT NULL DEFAULT 'ALL';
...
CREATE TABLE "role_capabilities" (
  ...
  CONSTRAINT "role_capabilities_roleId_fkey" FOREIGN KEY ("roleId") REFERENCES "roles"("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "role_register_access" (
  ...
  CONSTRAINT "role_register_access_roleId_fkey" FOREIGN KEY ("roleId") REFERENCES "roles"("id") ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT "role_register_access_registerId_fkey" FOREIGN KEY ("registerId") REFERENCES "cash_registers"("id") ON DELETE CASCADE ON UPDATE CASCADE
);
